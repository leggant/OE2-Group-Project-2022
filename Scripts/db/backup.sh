...
sudo cp /etc/rsyslog.d/50-default.conf ~/OE2-Group-Project/Db-VM
sudo cp /var/log/cron.log ~/OE2-Group-Project/Db-VM
sudo cp /var/log/user.log ~/OE2-Group-Project/Db-VM
sudo cp /var/log/daemon.log ~/OE2-Group-Project/Db-VM
