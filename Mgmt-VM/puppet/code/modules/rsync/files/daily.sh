...
OPTS="-haAXuv -v --progress --log-file=/home/$USER/log.log --backup-dir=~/backup/mgmt/backup/daily" 

rsync $OPTS $backupdir $BSERVER@$USERX:~/backup/mgmt/daily
...
BSERVER=groupb
USERX=restore-b.foo.org.nz
OPTS="-haAXuv -v --progress --log-file=/home/$USER/log.log --backup-dir=~/backup/db/backup/daily" 

rsync $OPTS $backupdir $BSERVER@$USERX:~/backup/db/daily
sudo chmod o-rx /etc/mysql/debian.cnf
#==========================================================================
elif [ $host == $app ]
then
...
BSERVER=groupb
USERX=restore-b.foo.org.nz
OPTS="-haAXuv -v --exclude --log-file=/home/$USER/log.log --backup-dir=~/backup/app/daily"
rsync $OPTS $backupdir $BSERVER@$USERX:~/backup/app/daily
sudo chmod o-rx /var/www/owncloud/data -R
...
BSERVER=groupb
USERX=restore-b.foo.org.nz
OPTS="-haAXuv -v --exclude --log-file=/home/$USER/log.log --backup-dir=~/backup/backup/daily"
rsync $OPTS $backupdir $BSERVER@$USERX:~/backup/backup
fi
